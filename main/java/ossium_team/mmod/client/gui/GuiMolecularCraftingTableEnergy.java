...
import ossium_team.mmod.common.block.container.ContainerMolecularCraftingTableEnergy;
...
public class GuiMolecularCraftingTableEnergy extends GuiContainer {

    private final ResourceLocation TEXTURE  = new ResourceLocation(ConstLib.MODID, "textures/gui/gui_molecular_crafting_table_energy.png");
    private final int TEXTURE_HEIGHT = 166, TEXTURE_WIDTH = 176;

    private TileMolecularCraftingTableEnergy tile;

    public GuiMolecularCraftingTableEnergy (IInventory playerInventory, TileMolecularCraftingTableEnergy tile) {
        super(new ContainerMolecularCraftingTableEnergy(playerInventory, tile));
        this.tile = tile;
    }
